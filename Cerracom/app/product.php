				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li><a href="#">Accesorios</a></li>
							<li><a href="#">Cerraduras</a></li>
							<li class="active">Nombre del roducto</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#">10 Opiniones | Agrega tu opinión</a>
							</div>
							<div>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Susan</h5>
															<p class="date">27 ENE 2021, 8:0 PM</p>
				...
				<div class="row">
					...
					<div class="col-md-3 col-xs-6">
						<div class="product">
							...
							<div class="product-body">
								<p class="product-category">Categoria</p>
								<h3 class="product-name"><a href="#">Nombre del producto aquí</a></h3>
								<h4 class="product-price">$980.00 <del class="product-old-price">$990.00</del></h4>
								<div class="product-rating">
								</div>
								<div class="product-btns">
