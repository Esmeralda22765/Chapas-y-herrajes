...
<!-- HEADER -->
    ...
    <main class="container">
      ...
      <input class="controls" type="text" name="usuario" value="" placeholder="Precio">
        <a>Stock</a> 
      <input class="controls" type="text" name="usuario" value="" placeholder="Stock">
       <a>Categoria</a> 
      <input class="controls" type="text" name="usuario" value="" placeholder="Categoria">
      <a>Marca</a> 
      <input class="controls" type="text" name="usuario" value="" placeholder="Marca">
      <a>Descuento</a> 
      <input class="controls" type="text" name="usuario" value="" placeholder="Descuento">
      <a>Proveedor</a> 
      <input class="controls" type="text" name="usuario" value="" placeholder="Proveedor">
      <a>Estado</a> 
      <input class="controls" type="text" name="usuario" value="" placeholder="Estado"><br>
      <a>Foto</a>  
