										...
										<div class="cart-list">
											<div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">1</span>$980.00</h4>
												</div>
											...
											<div class="product-widget">
												...
												<div class="product-body">
													<h3 class="product-name"><a href="#">Nombre producto</a></h3>
													<h4 class="product-price"><span class="qty">3</span>$980.00</h4>
												</div>
												<button class="delete"><i class="fa fa-close"></i></button>
											</div>
										</div>
										<div class="cart-summary">
											<small>3 artículo(s) seleccionado(s)</small>
											<h5>SUBTOTAL: $2940.00</h5>
										</div>
										<div class="cart-btns">
											<a href="#">Ver carrito</a>
											<a href="checkout.html">Pago  <i class="fa fa-arrow-circle-right"></i></a>
										</div>
									</div>
								</div>
								<!-- /Cart -->
				...
				<div class="row">
					...
					<div class="col-md-4 col-xs-6">
						<div class="shop">
							...
							<div class="shop-body">
								<h3>Herrajes<br>Colección</h3>
								<a href="checkout.html" class="cta-btn">Comprar ahora <i class="fa fa-arrow-circle-right"></i></a>
							</div>
						</div>
					</div>
					<!-- /shop -->
						...
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab1">Accesorios</a></li>
									<li><a data-toggle="tab" href="#tab1">Herrajes</a></li>
									<li><a data-toggle="tab" href="#tab1">Llaves</a></li>
									<li><a data-toggle="tab" href="#tab1">Chapas</a></li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="section-title">
							...
							<div class="section-nav">
								<ul class="section-tab-nav tab-nav">
									<li class="active"><a data-toggle="tab" href="#tab2">Llaves</a></li>
									<li><a data-toggle="tab" href="#tab1">Herrajes</a></li>
									<li><a data-toggle="tab" href="#tab1">Candados</a></li>
									<li><a data-toggle="tab" href="#tab1">Chapas</a></li>
								</ul>
							</div>
						</div>
